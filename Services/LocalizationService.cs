...
public class LocalizationService
{
    ...
    private readonly Dictionary<string, Dictionary<string, string>> _strings = new()
    {
        ["zh"] = new Dictionary<string, string>
        {
            ...
            ["ColumnType"] = "类型",
            ["ColumnFileType"] = "文件类型",
            ["FileType_ParentDir"] = "上级目录",
            ["FileType_Folder"] = "文件夹",
            ["FileType_Code"] = "代码",
            ["FileType_Excel"] = "Excel表格",
            ["FileType_Word"] = "Word文档",
            ["FileType_PPT"] = "PPT幻灯片",
            ["FileType_PDF"] = "PDF文档",
            ["FileType_Image"] = "图片",
            ["FileType_Video"] = "视频",
        ...
        ["en"] = new Dictionary<string, string>
        {
            ...
            ["FileType_ParentDir"] = "Parent Directory",
            ["FileType_Folder"] = "Folder",
            ["FileType_Code"] = "Code",
            ["FileType_Excel"] = "Excel",
            ["FileType_Word"] = "Word Document",
            ["FileType_PPT"] = "PPT Presentation",
